...
from multisynth.phantoms import CirclePhantomDistribution
    ...
    def get_CC_location(self, cct:CCType, attempts=1000) -> tuple:
        ...
        while attempts > 0:
            ...
            for cx, cy, r in self.circles:
                dist_from_circle = np.abs(np.sqrt((x - cx) ** 2 + (y - cy) ** 2) - r)
